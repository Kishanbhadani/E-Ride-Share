      ...
      <div>
        <div src='../assets/img/hero-banner.png' className='baner_img_main'>
          <div className="card-img-overlay banerCont1">
            ...
            <button type="button" className="btn btn-link p-1 pl-3 pr-3 bg-light">Subscribe Now</button>
          </div>
        </div>
        <div className="card">
          ...
          <div className="card-body">
            ...
            <form>
              <div className="form-row">
                ...
                <div className="form-group col-md-4">
                  <label for="inputPass4">To</label>
                  <input type='text' className="form-control" required></input>
                </div>
                <div className="form-group col-md-3">
                  <label for="inputPass4">Date</label>
              ...
              <button type='button submit'><Link to="/findride" className="btn btn-primary m-3">Find A Ride</Link></button>
              <button type='button submit'><Link to='/shareride' className='btn btn-primary'>Give A Ride</Link></button>
            </form>
          </div>
        </div>
        ...
        <a className="nft-b btn btn-primary"> read our help center</a><br></br>
